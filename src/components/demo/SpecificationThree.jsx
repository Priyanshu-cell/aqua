...
const SpecificationThree = ({ productDataThree }) => {
  ...
  return (
    <div className="p-6 md:px-32 mx-auto bg-gradient-to-r from-teal-200 via-blue-200 to-indigo-300 min-h-screen rounded-lg shadow-xl space-y-6">
      {/* Product Name */}
      ...
      {/* Usage Tips Section */}
      <div className="bg-white p-6 rounded-lg shadow-md">
        <h3 className="text-3xl font-semibold mb-6 text-teal-600">Usage Tips:</h3>
        <ul className="space-y-4">
